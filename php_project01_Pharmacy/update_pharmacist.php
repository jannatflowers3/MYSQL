...
// hidden input ar phid newya hoise
...
postal_address='$postal',phone='$phone',email='$email',username='$username', password='$pas' WHERE pharmacist_id='$phupDATE_id'";
...
<hr/>
    <div class="tabbed_area">
		...
		<?php echo $message1;?>
		<?php
	// $phid = $_GET['phhidden_id'];
	// hidden input k $phid diye call kora hoie  r phidden_id hose hidden id r value
	// admin id theke update a tag a phupdate_id newya hoise
		$sql = " SELECT * FROM pharmacist WHERE pharmacist_id = '$phupDATE_id'";
...
<!-- $id = $_POST['phid'] -->
			...
			<!-- <input type="hidden" name ="phhidden_id" value = "<?php //echo $phid ?>"> -->
		</form>
		</div>
    </div>
</div>
